...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H18.5C19.7426 20.75 20.75 19.7426 20.75 18.5V5.5C20.75 4.25736 19.7426 3.25 18.5 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H18.5C18.9142 4.75 19.25 5.08579 19.25 5.5V18.5C19.25 18.9142 18.9142 19.25 18.5 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V5.5ZM7.25 7.75C7.25 7.33579 7.58579 7 8 7H16C16.4142 7 16.75 7.33579 16.75 7.75C16.75 8.16421 16.4142 8.5 16 8.5H8C7.58579 8.5 7.25 8.16421 7.25 7.75ZM7.25 11.75C7.25 11.3358 7.58579 11 8 11H16C16.4142 11 16.75 11.3358 16.75 11.75C16.75 12.1642 16.4142 12.5 16 12.5H8C7.58579 12.5 7.25 12.1642 7.25 11.75ZM8 15C7.58579 15 7.25 15.3358 7.25 15.75C7.25 16.1642 7.58579 16.5 8 16.5H13.5C13.9142 16.5 14.25 16.1642 14.25 15.75C14.25 15.3358 13.9142 15 13.5 15H8Z" fill="currentColor"></path></svg>`,
      name: "Clases",
      path: "/classes",
    },
    {
  ...
  canShowNavItem(nav: NavItem): boolean {
    ...
    if (role === 'alumno') {
      return !nav.subItems && (nav.path === '/calendar' || nav.path === '/classes' || nav.path === '/profile');
    }
